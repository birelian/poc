package net.birelian.poc.di.spring;

import net.birelian.poc.di.spring.config.SpringContextConfig;
import net.birelian.poc.di.spring.model.Contact;
import net.birelian.poc.di.spring.service.ContactService;
...
public class Agenda {
    ...
    public static void main(String[] args) {
        ...
        Agenda agenda = new Agenda(contactService);
        agenda.run();
    }
